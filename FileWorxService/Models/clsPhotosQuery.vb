...
Public Class clsPhotosQuery
    ...
    Private Function getRows(filters As String) As Integer
        ...
        Dim query As String = "Select Count(T_PHOTO.ID) From T_BUSSINESSOBJECT,T_FILE,T_PHOTO " & filters
    ...
    Private Function buildQuery() As String
        ...
        "T_BUSSINESSOBJECT.C_CLASSID,T_FILE.C_BODY,T_PHOTO.C_LOCATION " &
        "from T_BUSSINESSOBJECT,T_FILE,T_PHOTO " &
        "where T_file.ID=T_BUSSINESSOBJECT.ID and T_PHOTO.id=T_BUSSINESSOBJECT.id"
    ...
    Public Function ListLoad() As clsListView
        ...
        For i As Integer = 0 To retreivedData.GetUpperBound(0)
            ...
            item.Values.Add(New clsListViewValue With {.Header = "Location", .Value = retreivedData(i, 6)})
