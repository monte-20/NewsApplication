...
Public Class clsNewsQuery
    ...
    Public Property filter() As clsNewsFilter = New clsNewsFilter
    ...
    Private Function getRows(filters As String) As Integer
        ...
        Dim query As String = "Select Count(T_NEWS.ID) From T_BUSSINESSOBJECT,T_FILE,T_NEWS " & filters
    ...
    Private Function BuildQuery() As String
        ...
        "T_BUSSINESSOBJECT.C_CLASSID,T_FILE.C_BODY,T_NEWS.C_CATEGORY " &
        "from T_BUSSINESSOBJECT,T_FILE,T_NEWS " &
        "where T_file.ID=T_BUSSINESSOBJECT.ID and T_NEWS.id=T_BUSSINESSOBJECT.id"
    ...
    Private Function addFilters() As String
        ...
        End If
        If filter.IsFilteredByCategory() Then
            If FilterAdded Then
                filters &= " and "
            End If
            filters &= addCategoryFilter()
        End If
    ...
    End Function
    Private Function addCategoryFilter() As String
        Return " T_NEWS.C_CATEGORY = @C_CATEGORY "
    End Function
    ...
    Private Function BuildSQLCommand(query As String) As SqlCommand
        ...
        With com
            ...
            End If
            If filter.IsFilteredByBody() Then
                .Parameters.AddWithValue("@C_CATEGORY", filter.CategoryFilter)
            End If
            If filter.IsFilteredByExactDate() Then
